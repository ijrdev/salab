# SALAB - Sistema de Agendamento de Laboratrios
...
- Administrador: Administra os usuários do sistema.
- Laboratorista: Gerencia as reservas e os laboratórios.
- Professor: Realiza o agendamento dos laboratórios.
